...
def declare_actions(launch_description: LaunchDescription, launch_args: LaunchArguments):
    ...
    # Launch Kinect Camera (sensor spawn) - ADDED HERE
    sensor_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory('sensors_demos_gazebo'),
                'launch',
                'kinect.launch.py'
            )
        ),
    ...
    launch_description.add_action(sensor_launch)
