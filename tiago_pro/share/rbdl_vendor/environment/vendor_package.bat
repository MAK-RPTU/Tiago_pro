...
call:ament_prepend_unique_value PATH "%AMENT_CURRENT_PREFIX%\opt\rbdl_vendor\bin"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\rbdl_vendor\lib"
call:ament_prepend_unique_value LD_LIBRARY_PATH "%AMENT_CURRENT_PREFIX%\opt\rbdl_vendor\lib64"
