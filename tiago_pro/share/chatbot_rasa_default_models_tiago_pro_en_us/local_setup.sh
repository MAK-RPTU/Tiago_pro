...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chatbot_rasa_default_models_tiago_pro_en_us/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chatbot_rasa_default_models_tiago_pro_en_us/environment/path.sh"
