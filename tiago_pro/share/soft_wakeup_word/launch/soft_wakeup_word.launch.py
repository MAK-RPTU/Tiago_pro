...
def generate_launch_description():
    pkg = 'soft_wakeup_word'
    namespace = ''
    node_name = 'soft_wakeup_word'
    node_executable = 'soft_wakeup_word'

    ld = LaunchDescription()
    config = get_pal_configuration(pkg=pkg, node=node_name, ld=ld, cmdline_args=['default_locale'])
